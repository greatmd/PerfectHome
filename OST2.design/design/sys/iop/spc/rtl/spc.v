...
// Donguk: Buffers for Global Signals (Repeaters) 
// DC + ICC can insert buffers for high-fanout & global signals 
// TODO: modify spc_rep1_dp.v to feed-through input ports to output ports
spc_rep1_dp rep1(
...
// Donguk : spu (streaming processing unit) is Crypto Unit. (Not necessary for synthesis)
spu spu (
	.scan_in(spu_scanin),
