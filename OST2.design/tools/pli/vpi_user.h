...
* 
* OpenSPARC T2 Processor File: vpi_user.h
...
XXTERN vpiHandle  vpi_put_value       PROTO_PARAMS((vpiHandle object,
                                                    ...
                                                    p_vpi_time time_p,
                                                    PLI_INT32 flags));
/******** Additional VPI routines for System Verilog **********/

XXTERN vpiHandle vpi_create_value(vpiHandle aggHandle);
XXTERN void vpi_copy_value(vpiHandle srcObject, vpiHandle valueHandle);
XXTERN void vpi_fill_member_value(vpiHandle aggHandle, vpiHandle valueHandle,
	vpiHandle memberHandle, p_vpi_value value_p);
