...
perlbot(1), perltoot(1), perlxs(1), perlxstut(1),
perlguts(1), overload(3).

=head1 VERSION

This man page documents "Bit::Vector::Overload" version 6.1.
...
Copyright (c) 2000 - 2001 by Steffen Beyer. All rights reserved.
