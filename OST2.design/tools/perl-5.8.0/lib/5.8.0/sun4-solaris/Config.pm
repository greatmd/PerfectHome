...
## Package name      : perl5
## Source directory  : .
## Configuration time: Wed Aug 28 13:15:21 PDT 2002
## Configured by     : santipon
## Target system     : sunos chakri1 5.8 generic_108528-13 sun4u sparc sunw,ultra-60 
#
## Configure command line arguments.
#PERL_PATCHLEVEL=

my $config_sh = <<'!END!';
archlibexp='/import/bw/tools/local/perl-5.8.0/lib/5.8.0/sun4-solaris'
...
installarchlib='/import/bw/tools/local/perl-5.8.0/lib/5.8.0/sun4-solaris'
installprivlib='/import/bw/tools/local/perl-5.8.0/lib/5.8.0'
libpth='/usr/local/lib /usr/lib /usr/ccs/lib'
libs='-lsocket -lnsl -ldl -lm -lc'
osname='solaris'
osvers='2.8'
prefix='/import/bw/tools/local/perl-5.8.0'
privlibexp='/import/bw/tools/local/perl-5.8.0/lib/5.8.0'
sharpbang='#!'
shsharp='true'
...
ar='ar'
archlib='/import/bw/tools/local/perl-5.8.0/lib/5.8.0/sun4-solaris'
archname64=''
archobjs=''
asctime_r_proto='0'
awk='awk'
baserev='5.0'
bash=''
bin='/import/bw/tools/local/perl-5.8.0/bin'
binexp='/import/bw/tools/local/perl-5.8.0/bin'
bison='bison'
byacc='byacc'
byteorder='4321'
c='\c'
...
ccversion=''
cf_by='santipon'
cf_email='santipon@chakri1.vlsi.eng.sun.com'
cf_time='Wed Aug 28 13:15:21 PDT 2002'
charsize='1'
chgrp=''
chmod='chmod'
chown=''
...
config_arg1='-Dprefix=/import/bw/tools/local/perl-5.8.0'
config_arg2='-d'
config_argc='2'
config_args='-Dprefix=/import/bw/tools/local/perl-5.8.0 -d'
contains='grep'
cp='cp'
cpio=''
cpp='cpp'
...
cpprun='cc -E'
cppstdin='cc -E'
cppsymbols='_BIG_ENDIAN=1 _FILE_OFFSET_BITS=64 _ILP32=1 _LARGEFILE64_SOURCE=1 _LARGEFILE_SOURCE=1 __STDC__=1 __SVR4=1 sparc=1 __sparc=1 sun=1 __sun=1 unix=1 __unix=1'
crypt_r_proto='0'
cryptlib=''
csh='csh'
ctermid_r_proto='0'
...
incpath=''
inews=''
installbin='/import/bw/tools/local/perl-5.8.0/bin'
installman1dir='/import/bw/tools/local/perl-5.8.0/man/man1'
installman3dir='/import/bw/tools/local/perl-5.8.0/man/man3'
installprefix='/import/bw/tools/local/perl-5.8.0'
installprefixexp='/import/bw/tools/local/perl-5.8.0'
installscript='/import/bw/tools/local/perl-5.8.0/bin'
installsitearch='/import/bw/tools/local/perl-5.8.0/lib/site_perl/5.8.0/sun4-solaris'
installsitebin='/import/bw/tools/local/perl-5.8.0/bin'
installsitelib='/import/bw/tools/local/perl-5.8.0/lib/site_perl/5.8.0'
installstyle='lib'
...
libsfound=' /usr/lib/libsocket.so.1 /usr/lib/libnsl.so.1 /usr/lib/libdl.so.1 /usr/lib/libm.so.1 /usr/lib/libc.so.1'
...
mallocsrc=''
malloctype='void *'
man1dir='/import/bw/tools/local/perl-5.8.0/man/man1'
man1direxp='/import/bw/tools/local/perl-5.8.0/man/man1'
man1ext='1'
man3dir='/import/bw/tools/local/perl-5.8.0/man/man3'
man3direxp='/import/bw/tools/local/perl-5.8.0/man/man3'
man3ext='3'
mips_type=''
mkdir='mkdir'
mmaptype='caddr_t'
...
mydomain='.vlsi.eng.sun.com'
myhostname='chakri1'
myuname='sunos chakri1 5.8 generic_108528-13 sun4u sparc sunw,ultra-60 '
n=''
need_va_copy='undef'
netdb_hlen_type='int'
...
patchlevel='8'
path_sep=':'
perl5='/import/bw-tools/local/bin/perl'
perl=''
perl_patchlevel=''
perladmin='santipon@chakri1.vlsi.eng.sun.com'
perllibs='-lsocket -lnsl -ldl -lm -lc'
perlpath='/import/bw/tools/local/perl-5.8.0/bin/perl'
pg='pg'
phostname='hostname'
pidtype='pid_t'
plibpth=''
...
pmake=''
pr=''
prefixexp='/import/bw/tools/local/perl-5.8.0'
privlib='/import/bw/tools/local/perl-5.8.0/lib/5.8.0'
procselfexe=''
prototype='define'
ptrsize='4'
quadkind='3'
...
sSCNfldbl='"Lf"'
sched_yield='undef'
scriptdir='/import/bw/tools/local/perl-5.8.0/bin'
scriptdirexp='/import/bw/tools/local/perl-5.8.0/bin'
sed='sed'
seedfunc='srand48'
selectminbits='32'
selecttype='fd_set *'
...
sig_size='49'
signal_t='void'
sitearch='/import/bw/tools/local/perl-5.8.0/lib/site_perl/5.8.0/sun4-solaris'
sitearchexp='/import/bw/tools/local/perl-5.8.0/lib/site_perl/5.8.0/sun4-solaris'
sitebin='/import/bw/tools/local/perl-5.8.0/bin'
sitebinexp='/import/bw/tools/local/perl-5.8.0/bin'
sitelib='/import/bw/tools/local/perl-5.8.0/lib/site_perl/5.8.0'
sitelib_stem='/import/bw/tools/local/perl-5.8.0/lib/site_perl'
sitelibexp='/import/bw/tools/local/perl-5.8.0/lib/site_perl/5.8.0'
siteprefix='/import/bw/tools/local/perl-5.8.0'
siteprefixexp='/import/bw/tools/local/perl-5.8.0'
sizesize='4'
sizetype='size_t'
sleep=''
smail=''
...
src='.'
ssizetype='ssize_t'
startperl='#!/import/bw/tools/local/perl-5.8.0/bin/perl'
