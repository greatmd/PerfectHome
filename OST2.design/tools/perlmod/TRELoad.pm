...
# 
# OpenSPARC T2 Processor File: TRELoad.pm
...
that begin with '/' or '!/'.  There is no reason this could not be made
to work, but it is a fair amount of work and this feature is almost
never used.
