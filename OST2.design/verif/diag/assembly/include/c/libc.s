...
* 
* OpenSPARC T2 Processor File: libc.s
...
alloc:	
	...
	!#PROLOGUE# 0
	!#PROLOGUE# 1
	sethi   %hi(__nxtfree.0), %g1
	ldx     [%g1+%lo(__nxtfree.0)], %g2
	add     %o0, %g2, %o0
	stx     %o0, [%g1+%lo(__nxtfree.0)]
	sethi   %hi(user_heap_start), %o0
	or      %o0, %lo(user_heap_start), %o0
	retl
	add     %g2, %o0, %o0
/* linhai88 */
...
!--------------------------------------------------------------------------
! These below were inline( functions in tests...
