...
TS6N28HPMA256X64M4F frf_h0
  (
  .AA(w1_addr[7:0]),
  .D({25'b0,w1_data[38:0]}),
  .WEB(~(w1_valid & ~tcu_array_wr_inhibit)),
  .CLKW(clk),
  .AB(r1_addr[7:0]),
  .REB(~masked_r1_valid),
  .CLKR(clk),
...
TS6N28HPMA256X64M4F frf_h1
  (
   .AA(w2_addr[7:0]),
  .D({25'b0,w2_data[38:0]}),
  .WEB(~(w2_valid & ~tcu_array_wr_inhibit)),
  .CLKW(clk),
  .AB(r2_addr[7:0]),
  .REB(~masked_r2_valid),
  .CLKR(clk),
